...
public final class update_005fcliententry_005fprocess_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try{
      ...
      out.write("\t\t}\n");
      out.write("\n");
      out.write("\t\t// validation for Proffession\n");
      out.write("\t\tif(document.f1.profession.value==\"\")\n");
      out.write("\t\t{\n");
      out.write("\t\t\talert(\"Please select Proffession\");\n");
      out.write("\t\t\tdocument.f1.profession.focus();\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t}\n");
      out.write("\n");
      out.write("\t\t\n");
      out.write("\t\t// validation for client information\n");
      out.write("\t\tif(document.f1.client_suggested_info.value==\"\")\n");
      out.write("\t\t{\n");
      out.write("\t\t\talert(\"Please enter the Client Suggested Information\");\n");
      out.write("\t\t\tdocument.f1.client_suggested_info.focus();\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t}\n");
      ...
      out.write("       <form name=\"f1\" method=\"POST\" action=\"update_client_enquiry.jsp\">\n");
      out.write("   \t \t<h3 class=\"text-center\">Update User</h3>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("   \t \t\t\n");
      out.write("                    <input type=\"hidden\" name=\"client_id\" class=\"form-control\" value=\"");
      out.print(rs.getInt("CLIENT_ID"));
      out.write("\">\n");
      out.write("   \t \t</div>\n");
      out.write("   \t \t<div class=\"form-group\">\n");
      out.write("   \t \t\tEnquiry Date\n");
      ...
      out.write("   \t \t</div>\n");
      out.write("   \t \t<div class=\"form-group\">\n");
      out.write("                    Client Suggested Information\n");
      out.write("                    <input type=\"text\" name=\"client_suggested_info\" class=\"form-control\" value=\"");
      ...
      out.write("\">Select Status</label>\n");
      out.write("   \t \t\t<div class=\"radio-inline\">\n");
      out.write("   \t \t\t\t<input type=\"radio\" name=\"status\" value=\"FollowUP\">Follow Up\n");
      out.write("   \t \t\t</div>\n");
      out.write("   \t \t\t<div class=\"radio-inline\">\n");
      out.write("   \t \t\t\t<input type=\"radio\" name=\"status\" value=\"Lead\">Lead\n");
      out.write("   \t \t\t</div>\n");
      out.write("   \t \t\t<div class=\"radio-inline\">\n");
      out.write("   \t \t\t\t<input type=\"radio\" name=\"status\" value=\"Not Intrested\">Not Intrested\n");
      out.write("   \t \t\t</div>\n");
      out.write("   \t \t</div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("   \t \t\t<button class=\"btn btn-info\" type=\"submit\" onclick=\"return validation()\">Update User</button>\n");
